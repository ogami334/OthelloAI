...
public class OthelloAIForAIvsHuman2 : MonoBehaviour
{
    ...
    void Start() {
        File.AppendAllText(@"C:\Users\denjo\Downloads\12ゲームAI リバーシ\Othello\result2.txt","-1"+System.Environment.NewLine);
    ...
    void AIPlay() {
        ...
        File.AppendAllText(@"C:\Users\denjo\Downloads\12ゲームAI リバーシ\Othello\result2.txt",sw.ElapsedMilliseconds.ToString()+System.Environment.NewLine);
        DestroyAllStar();
